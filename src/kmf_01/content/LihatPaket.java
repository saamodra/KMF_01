...
public class LihatPaket extends javax.swing.JFrame {
    ...
    private void loadData(String cari) {
        ...
        try {
            ...
            while(c.result.next()) {
                ...
                obj[3] = f.format(r.getDate("tgl_masuk"));
                obj[4] = r.getString("jenis_pengiriman");
                obj[5] = r.getString("biaya_kirim");
                obj[6] = r.getString("status_paket");
                obj[7] = r.getString("nama_pelanggan");
                obj[8] = r.getString("kota_asal");
                obj[9] = r.getString("alamat_asal");
                obj[10] = r.getString("nohp_pelanggan");
                obj[11] = r.getString("nama_penerima");
                obj[12] = r.getString("kota_tujuan");
                obj[13] = r.getString("alamat_tujuan");
                obj[14] = r.getString("telepon_penerima");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LihatPaket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LihatPaket().setVisible(true);
            }
        });
    }
